...
@font-face {
  ...
  src: url(https://github.com/max32002/swei-b2-sans/raw/master/WebFont/CJK%20TC/SweiB2SansCJKtc-Regular.woff2) format("woff2")
  , url(https://github.com/max32002/swei-b2-sans/raw/master/WebFont/CJK%20TC/SweiB2SansCJKtc-Regular.woff) format("woff");
}
```
